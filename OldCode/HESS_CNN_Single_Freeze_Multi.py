...
from tensorflow.keras.layers import Input, Concatenate, concatenate, Dense,Lambda,Reshape,Embedding, Conv2D, Conv3D, MaxPooling2D, MaxPooling3D, Flatten, Dropout, ConvLSTM2D, BatchNormalization, LeakyReLU, AveragePooling2D
...
def create_base_model_customresnet(inputs,freeze=False):
    ...
    x = outer_block(x,1024)
    x = outer_block(x,512)
    x = outer_block(x,1024)
    x = outer_block(x,2048)

    x = GlobalAveragePooling2D()(x)
    x = Dense(units=1024, activation='softmax')(x)
...
def create_base_model_seemann(inputs,freeze=False):
    ...
    # first layers
    conv1 = Conv2D(filters=32,kernel_size=7,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(inputs)
    maxpool1 = MaxPooling2D(2, padding='same')(conv1)
    b00_output_c = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(maxpool1)

    # block 0.1
    b01_c1 = Conv2D(filters=256,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b00_output_c)
    b01_c2 = Conv2D(filters=256,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b01_c1)
    b01_c3 = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b01_c2)
    b01_output = layers.add([b00_output_c,b01_c3])
    # block 0.2
    b02_c1 = Conv2D(filters=256,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b01_output)
    b02_c2 = Conv2D(filters=256,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b02_c1)
    b02_c3 = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b02_c2)
    b02_output = layers.add([b01_output,b02_c3])
    # block 0.3
    b03_c1 = Conv2D(filters=256,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b02_output)
    b03_c2 = Conv2D(filters=256,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b03_c1)
    b03_c3 = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b03_c2)
    b03_output = layers.add([b02_output,b03_c3])
    b03_output_c = Conv2D(filters=512,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b03_output)

    # block 1.1
    b11_c1 = Conv2D(filters=64,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b03_output_c)
    b11_c2 = Conv2D(filters=128,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b11_c1)
    b11_c3 = Conv2D(filters=512,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b11_c2)
    b11_output = layers.add([b03_output_c,b11_c3])
    # block 1.2
    b12_c1 = Conv2D(filters=128,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b11_output)
    b12_c2 = Conv2D(filters=128,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b12_c1)
    b12_c3 = Conv2D(filters=512,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b12_c2)
    b12_output = layers.add([b11_output,b12_c3])
    # block 1.3
    b13_c1 = Conv2D(filters=128,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b12_output)
    b13_c2 = Conv2D(filters=128,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b13_c1)
    b13_c3 = Conv2D(filters=512,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b13_c2)
    b13_output = layers.add([b12_output,b13_c3])
    b13_output_c = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b13_output)

    # block 2.1
    b21_c1 = Conv2D(filters=128,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b13_output_c)
    b21_c2 = Conv2D(filters=256,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b21_c1)
    b21_c3 = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b21_c2)
    b21_output = layers.add([b13_output_c,b21_c3])
    # block 2.2
    b22_c1 = Conv2D(filters=256,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b21_output)
    b22_c2 = Conv2D(filters=256,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b22_c1)
    b22_c3 = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b22_c2)
    b22_output = layers.add([b21_output,b22_c3])
    # block 2.3
    b23_c1 = Conv2D(filters=256,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b22_output)
    b23_c2 = Conv2D(filters=256,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b23_c1)
    b23_c3 = Conv2D(filters=1024,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b23_c2)
    b23_output = layers.add([b22_output,b23_c3])
    b23_output_c = Conv2D(filters=2048,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b23_output)


    # block 3.1
    b31_c1 = Conv2D(filters=256,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b23_output_c)
    b31_c2 = Conv2D(filters=512,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b31_c1)
    b31_c3 = Conv2D(filters=2048,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b31_c2)
    b31_output = layers.add([b23_output_c,b31_c3])    
    # block 3.2
    b32_c1 = Conv2D(filters=512,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b31_output)
    b32_c2 = Conv2D(filters=512,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b32_c1)
    b32_c3 = Conv2D(filters=2048,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b32_c2)
    b32_output = layers.add([b31_output,b32_c3])  
    # block 3.3
    b33_c1 = Conv2D(filters=512,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b32_output)
    b33_c2 = Conv2D(filters=512,kernel_size=3,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b33_c1)
    b33_c3 = Conv2D(filters=2048,kernel_size=1,padding='same',kernel_regularizer=regularizers.l2(reg), input_shape=input_shape,)(b33_c2)
    b33_output = layers.add([b32_output,b33_c3])  

    # last layers
    avgpool1 = AveragePooling2D(pool_size=2,padding='same')(b33_output)
    flat1 = Flatten()(avgpool1)
    dense1 = Dense(units=1024, activation='relu')(flat1)
...
def create_multiview_model_latemax(models,inputs):
    multi_rate = 0.5
    ...
    #x = Dropout(multi_rate)(x)
    #x = Dense(units=50, activation='relu')(x)
    x = Dropout(multi_rate)(max_pooled)
    outputs = Dense(units=1, activation='sigmoid')(x)
    model_single = Model(inputs,outputs)
    return model_single
...
if base == 'moda':
    ...
    base_cnn = create_base_model_customresnet(inputs)
else: print("Error: Unknown base model type specified in parser!")
...
if base == 'moda':
    ...
    if transfer == 'yes':
        ...
        input_1 = Input(shape=input_shape)
        cnn_model_1 = create_base_model_customresnet(input_1, freeze=True)
        cnn_model_1.load_weights('single_cnn_weights_partial.h5', by_name=True)

        input_2 = Input(shape=input_shape)
        cnn_model_2 = create_base_model_customresnet(input_2, freeze=True)
        cnn_model_2.load_weights('single_cnn_weights_partial.h5', by_name=True)

        input_3 = Input(shape=input_shape)
        cnn_model_3 = create_base_model_customresnet(input_3, freeze=True)
        cnn_model_3.load_weights('single_cnn_weights_partial.h5', by_name=True)

        input_4 = Input(shape=input_shape)
        cnn_model_4 = create_base_model_customresnet(input_4, freeze=True)
        cnn_model_4.load_weights('single_cnn_weights_partial.h5', by_name=True)
    else: 
        input_1 = Input(shape=input_shape)
        cnn_model_1 = create_base_model_customresnet(input_1)
        input_2 = Input(shape=input_shape)
        cnn_model_2 = create_base_model_customresnet(input_2)
        input_3 = Input(shape=input_shape)
        cnn_model_3 = create_base_model_customresnet(input_3)
        input_4 = Input(shape=input_shape)
        cnn_model_4 = create_base_model_customresnet(input_4)     
