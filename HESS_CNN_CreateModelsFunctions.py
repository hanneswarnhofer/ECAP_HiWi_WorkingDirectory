...
def create_base_model_customresnet2(inputs,model_name,dropout_rate,filters_1,filters_2,filters_3,freeze=False):
...
def create_base_model_customresnet(inputs, model_name, dropout_rate ,filters_1,filters_2,filters_3,start_layer=-1,freeze=False, dynamic_input_shape=False ):
...
def create_base_model(inputs,kernel_size,dropout_rate,reg,pool_size,freeze=False):
