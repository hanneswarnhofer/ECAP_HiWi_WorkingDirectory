...
class MyGenerator(keras.utils.Sequence):
    ...
    def __getitem__(self,index):
        ...
        X = np.array(self.images_1[idx_low:idx_high])
    ...
    def __getitem__(self,index):
        ...
        self.data = (images_batch_1, labels_batch)
...
history = model.fit(training_generator, epochs=num_epochs, batch_size= batch_size,validation_data=testing_generator, callbacks=[early_stopping_callback_1])
